    ...
    <div className="space-y-4 px-5 py-5 border">
      ...
      {props.posts.map((post, index) => (
        <div key={index} className="flex gap-4">
          <img src={post.image} alt={post.title} className="object-cover rounded-lg cursor-pointer transition duration-300 ease-in-out transform hover:scale-110" style={{height:'160px', width:'200px'}}/>
          <div>
